...
var (
	_ sdk.Msg              = (*MsgPushNewWasmCode)(nil)
	_ sdk.HasValidateBasic = (*MsgPushNewWasmCode)(nil)
	_ sdk.Msg              = (*MsgUpdateWasmCodeId)(nil)
	_ sdk.HasValidateBasic = (*MsgUpdateWasmCodeId)(nil)
)
...
func (m MsgPushNewWasmCode) ValidateBasic() error {
	if len(m.Code) == 0 {
		return errorsmod.Wrapf(ErrWasmEmptyCode,
			"empty wasm code",
		)
	}
