...
func (suite *TypesTestSuite) TestUpdateState() {
	...
	testCases := []struct {
		...
		},
		{
			...
			fmt.Errorf("expected type %T, got %T", (*types.ClientState)(nil), (*ibctm.Misbehaviour)(nil)),
			nil,
		},
		{
...
func (suite *TypesTestSuite) TestUpdateStateOnMisbehaviour() {
	...
	testCases := []struct {
		...
		},
		{
			...
			fmt.Errorf("expected type %T, got %T", (*types.ClientState)(nil), (*ibctm.Header)(nil)),
			nil,
		},
		{
